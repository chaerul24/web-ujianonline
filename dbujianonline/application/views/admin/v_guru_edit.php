        ...
        <div class="box box-success" style="overflow-x: scroll;">
            ...
            <form action="<?=base_url('guru/update');?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <input type="hidden" name="id_guru" value="<?= $a->id_guru;?>">

                <div class="form-group">
                  <label class="col-sm-2 control-label">NIP</label>
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="nip" value="<?= $a->nip;?>">
                  </div>
                </div>
                ...
                <div class="col-sm-10">
                  ...
                  <button type="submit" class="btn btn-primary btn-flat" title="Simpan Data Guru"><span class="fa fa-save"></span> Simpan</button>
                </div>
              </div>
